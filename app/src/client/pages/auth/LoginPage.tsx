          ...
          <div className="hidden lg:block space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-bordeaux-900 mb-1">Member Management</h3>
                  <p className="text-gray-600">Track subscriptions, analyze preferences, and grow your wine community.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-bordeaux-900 mb-1">Automated Operations</h3>
                  <p className="text-gray-600">Streamline billing, inventory, and shipping with smart automation.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-bordeaux-900 mb-1">Secure & Compliant</h3>
                  <p className="text-gray-600">Bank-level security with GDPR compliance and PCI certification.</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-bordeaux-900">50K+</div>
                <div className="text-sm text-gray-600">Members</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-bordeaux-900">98%</div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-bordeaux-50 rounded-full mb-4">
                  ...
                  <span className="text-bordeaux-700 text-sm font-medium uppercase tracking-wider">Welcome Back</span>
                </div>
