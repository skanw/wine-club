    ...
    <div className="min-h-screen bg-gradient-to-br from-champagne-50 via-white to-bordeaux-50">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-bordeaux-700 max-w-2xl mx-auto text-center mb-12">
            {tFallback('howitworks.steps.subtitle', 'From signup to your first delivery, we make the wine journey effortless')}
          </p>
          
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow duration-300 relative">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-bordeaux-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  {step.number}
                </div>
                <div className="flex items-center justify-center w-16 h-16 bg-bordeaux-100 rounded-full text-bordeaux-600 mb-6 mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gradient-to-br from-bordeaux-50 to-champagne-50 rounded-2xl p-8 text-center transition-transform duration-300 hover:scale-105">
                <div className="flex items-center justify-center w-16 h-16 bg-bordeaux-600 rounded-full text-white mb-6 mx-auto">
      ...
      <section className="py-16 bg-bordeaux-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-champagne-500 text-bordeaux-900 px-8 py-4 rounded-lg hover:bg-champagne-400 transition-colors duration-300 font-medium text-lg">
              {tFallback('howitworks.cta.start', 'Start Your Free Trial')}
            </button>
            <button className="border border-champagne-300 text-champagne-100 px-8 py-4 rounded-lg hover:bg-champagne-100 hover:text-bordeaux-900 transition-colors duration-300 font-medium text-lg">
