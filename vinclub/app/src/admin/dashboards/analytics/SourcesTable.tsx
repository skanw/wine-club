...
const SourcesTable = ({ sources }: { sources: PageViewSource[] | undefined }) => {
  return (
    <div className='rounded-sm border border-border bg-card px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1'>
      <h4 className='mb-6 text-xl font-semibold text-foreground'>Principales sources</h4>
      ...
      <div className='flex flex-col'>
        <div className='grid grid-cols-3 rounded-sm bg-gray-2 '>
          ...
          <div className='p-2.5 text-center xl:p-5'>
            <h5 className='text-sm font-medium uppercase xsm:text-base'>Visiteurs</h5>
          </div>
          <div className='hidden p-2.5 text-center sm:block xl:p-5'>
            <h5 className='text-sm font-medium uppercase xsm:text-base'>Ventes</h5>
          </div>
        </div>
