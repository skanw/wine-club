...
export interface BentoProps {
  ...
  onCardClick?: (card: BentoCardProps, index: number) => void;
}
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-4 p-3 max-w-[90rem] select-none relative mx-auto"
      ...
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            /* First big card - top left, spans 2 columns, 2 rows */
            .card-responsive .card:nth-child(1) {
              grid-column: 1 / span 2;
              grid-row: 1 / span 2;
            }
            
            /* First rectangle card - top right, spans 2 columns, 1 row */
            .card-responsive .card:nth-child(2) {
              grid-column: 3 / span 2;
              grid-row: 1 / span 1;
            }
            
            /* Second rectangle card - bottom left, spans 2 columns, 1 row */
            .card-responsive .card:nth-child(3) {
              grid-column: 1 / span 2;
              grid-row: 3 / span 1;
            }
            
            /* Second big card - bottom right, spans 2 columns, 2 rows */
              ...
              <div
                ...
                ref={el => {
                  ...
                  const handleClick = (e: MouseEvent) => {
                    ...
                    // Always call onCardClick if provided
                    handleCardClick();
                  };
