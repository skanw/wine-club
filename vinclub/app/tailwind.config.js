  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        didone: ['Bodoni Moda', 'Didot', 'Italiana', 'Prata', 'serif'],
        sans: ['Bodoni Moda', 'Didot', 'Italiana', 'Prata', 'serif'],
      },
      letterSpacing: {
        'medium-wide': '0.075em', /* 0.05em to 0.1em range */
        'wide': '0.15em',
        'extra-wide': '0.2em',
        'ultra-wide': '0.4em',
      },
      colors: {
        ...
        input: 'hsl(var(--input))',
        ring: 'hsl(var(--ring))',
        // Vintage Oenology Color Palette
        'vintage-wine': '#3F1521',
        'label-cream': '#F4F4F0',
        'gold-foil': '#A48F5D',
      },
